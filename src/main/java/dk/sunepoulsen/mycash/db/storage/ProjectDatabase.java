package dk.sunepoulsen.mycash.db.storage;
...
public class ProjectDatabase {
    ...
    private static final String PERSISTENCE_NAME = "mycash";
    ...
    public ProjectDatabase( String url ) {
        this( PERSISTENCE_NAME, url );
    }

    public ProjectDatabase( String persistenceName, String url ) {
